...
小さなボックスの中からスタートします。そのボックスの外 — モブ、ブロック、リソース — はすべてオフリミットです。より多くのスペースを得るには、それを獲得する必要があります。実績を達成するとボックスが広がります。すべての実績が重要です。新しい領土のブロックは、あなたが獲得した報酬です。

**Boxed** はツイストのあるアイランドゲームモードです。ワールドはマイニングやビルディングからは広がらず、*何かをすること*によって広がります。何か新しいものをクラフトしましょう。構造物を探索してください。モブを倒してください。作物を育ててください。バニラの進捗ツリー全体があなたの進捗を駆動し、オプションのカスタムデータパックはさらに多くの目標を提供します。
...
公式 **BoxedDataPack** は Boxed のために特別に設計されたカスタム実績セットを追加し、プレイヤーが追い求めるものを増やし、サーバーをより完全な体験にします。

[最新の BoxedDataPack リリースをダウンロード](https://github.com/BentoBoxWorld/BoxedDataPack/releases)して、`.zip` ファイルをサーバーの `world/datapacks/` フォルダ（または Boxed が実行されているワールド）にドロップし、`/reload` または再起動を実行してください。

自分で作成したいですか？Boxed の拡張システムと統合するカスタム実績を作成する方法については、[チュートリアル動画](https://youtu.be/zNzQvIbweQs)をご覧ください。
